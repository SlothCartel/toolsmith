...
- **Minimal dependencies.** Prefer the standard library. Each non-development dependency added in a later phase must have an explicit Phase 1+ justification recorded in `AGENTS.md`.
...
- Email Improver, Error Explainer, Requirements Reviewer, or any other future command.
